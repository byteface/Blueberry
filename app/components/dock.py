                ...
                div(_class="dock").html(
                    ul(
                        ...
                        li(_id="launchPad").html(
                            # a(_href="#warning", **{"_data-rel": "showOp"}).html(
                            div(
                                _onclick="add_to_page('/component/launcher?&id=launcher')"
                            ).html(
                                em(span("Apps")),
                        ...
                        if self.settings["GITHUB"]
                        else "",  # inline ternary condition! cool!
                        li(_id="safari").html(
                            a(_href="#warning", **{"_data-rel": "showOp"}).html(
                                em(span("Safari")),
                        ...
                        li(_id="preferences").html(
                            ...
                            div(
                                _onclick="add_to_page('/component?file=config.ini&id=config_pad')"
                            ).html(
                                em(span("Configuration")),
                                img(
                                    _src="assets/img/preferences.png",
                                    _alt="preferences",
                                ),
                            )
                        ),
